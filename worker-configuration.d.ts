/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: fec0999bba9cafaa45856a70518c8f40)
// Runtime types generated with workerd@1.20260504.1 2025-10-08 
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "UserThreadDO";
	}
	interface Env {
		REALTIME_TOKEN_SECRET: string;
		REALTIME_SERVICE_SECRET: string;
		APPS_BUSINESS_URL: string;
		USER_THREAD_DO: DurableObjectNamespace<import("./src/index").UserThreadDO>;
	}
}
